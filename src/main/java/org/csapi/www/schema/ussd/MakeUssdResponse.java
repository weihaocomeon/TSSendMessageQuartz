...
public class MakeUssdResponse  implements java.io.Serializable {
    private java.lang.String ussdIdentifier;

    public MakeUssdResponse() {
    }
    ...
    /**
     * Gets the ussdIdentifier value for this MakeUssdResponse.
     * 
    ...
    /**
     * Sets the ussdIdentifier value for this MakeUssdResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MakeUssdResponse)) return false;
        MakeUssdResponse other = (MakeUssdResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MakeUssdResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.csapi.org/schema/ussd", ">makeUssdResponse"));
