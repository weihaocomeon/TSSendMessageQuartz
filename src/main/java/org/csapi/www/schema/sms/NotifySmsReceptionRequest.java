...
public class NotifySmsReceptionRequest  implements java.io.Serializable {
    private org.csapi.www.schema.sms.SMSMessage message;

    public NotifySmsReceptionRequest() {
    }

    public NotifySmsReceptionRequest(
           org.csapi.www.schema.sms.SMSMessage message) {
     ...
     * @return message
     */
    public org.csapi.www.schema.sms.SMSMessage getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(org.csapi.www.schema.sms.SMSMessage message) {
        this.message = message;
    }
