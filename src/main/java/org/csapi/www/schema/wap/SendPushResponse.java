...
public class SendPushResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the requestIdentifier value for this SendPushResponse.
     * 
    ...
    /**
     * Sets the requestIdentifier value for this SendPushResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SendPushResponse)) return false;
        SendPushResponse other = (SendPushResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SendPushResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.csapi.org/schema/wap", ">sendPushResponse"));
