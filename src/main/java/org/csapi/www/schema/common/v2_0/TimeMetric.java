...
public class TimeMetric  implements java.io.Serializable {
    private org.csapi.www.schema.common.v2_0.TimeMetricsValues metric;
    ...
    public TimeMetric(
           org.csapi.www.schema.common.v2_0.TimeMetricsValues metric,
           int units) {
           this.metric = metric;
           this.units = units;
    }
     ...
     * @return metric
     */
    public org.csapi.www.schema.common.v2_0.TimeMetricsValues getMetric() {
        return metric;
    }
     ...
     * @param metric
     */
    public void setMetric(org.csapi.www.schema.common.v2_0.TimeMetricsValues metric) {
        this.metric = metric;
    }
