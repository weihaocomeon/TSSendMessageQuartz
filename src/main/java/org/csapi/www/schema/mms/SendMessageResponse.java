...
public class SendMessageResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the requestIdentifier value for this SendMessageResponse.
     * 
    ...
    /**
     * Sets the requestIdentifier value for this SendMessageResponse.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.csapi.org/schema/mms", ">sendMessageResponse"));
